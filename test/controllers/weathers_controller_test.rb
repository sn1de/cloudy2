...
class WeathersControllerTest < ActionController::TestCase
  ...
  test "should create weather" do
    assert_difference('Weather.count') do
      post :create, weather: { chance_of_meatballs: @weather.chance_of_meatballs, forecast: @weather.forecast }
    end
  ...
  test "should update weather" do
    patch :update, id: @weather, weather: { chance_of_meatballs: @weather.chance_of_meatballs, forecast: @weather.forecast }
    assert_redirected_to weather_path(assigns(:weather))
  end
